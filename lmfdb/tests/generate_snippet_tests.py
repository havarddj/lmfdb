            ...
            if error_file is not None:
                if not error_file.exists():
                    ...
                    with open(error_file, "w") as f:
                        ...
                        f.write(f"Generated by generate_snippet_tests on {str(datetime.date.today())}\n\n")
                
                with open(error_file, "a") as f:
                    f.write(f"## In [{str(logfile)}](../blob/master{str(logfile)}#L{line}), lines {line} to {line_end}:\n")
                    f.write(f'```{lang}\n')
                    f.write(text)
                    f.write(f'\n```\n\n')
